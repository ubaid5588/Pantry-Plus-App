...
class ProductDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dataProvider = Provider.of<BackendData>(context, listen: false);
    final dummyData = dataProvider.backendData;
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            args.ratingReview.isNotEmpty
                                ? RatingBar.readOnly(
                                    initialRating: dataProvider
                                        .totalProductRating(args.id),
                        ...
                        Text(
                          args.description,
                          style: GoogleFonts.getFont('Poppins', fontSize: 17),
                        ),
                        ...
                        args.ratingReview.isNotEmpty
                            ? RatingBar.readOnly(
                                initialRating: dataProvider.totalProductRating(
                                  args.id,
                                ),
                                filledIcon: Icons.star,
                                emptyIcon: Icons.star_border,
