...
class SearchedScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dataPrvider = Provider.of<BackendData>(context, listen: false);
    final searchProduct = ModalRoute.of(context)!.settings.arguments as String;
    final dummyData = Provider.of<BackendData>(context).backendData;
                ...
                itemBuilder: (context, index) {
                  return InkWell(
                    ...
                    child: ProductItem(
                      ...
                      rating: dataPrvider.totalProductRating(
                        findProducts[index].id,
                      ),
                    ),
                  );
                },
